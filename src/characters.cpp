...
void Ghost::move(int target_x, int target_y, double speed)
{
	...
	{
		if ((poss[hori] == 0 && poss[verti] != 0) || (poss[hori] != 0 && poss[verti] == 0))
		{
			type = 3;
		}
		else
	...
	else if (cnt == 3)
	{
		...
		else if (poss[hori] != 0 && poss[verti] != 0)
		{
			type = 5;
		}
	}
